...
\renewcommand{\baselinestretch}{0.70} % Reduces line spacing
...
\cventry{2021--Present}{Bachelor in Communication Systems}{EPFL}{Lausanne, Switzerland}{}{
  ...
  \begin{itemize}
    ...
    \item Relevant coursework: Algorithm, Computer Systems, Introduction to Machine Learning, Numerical Methods for Visual Computing and Machine Learning, Software Construction.
  \end{itemize}
}
...
\cventry{}{Image File System}{Computer Systems}{}{}{
	\begin{itemize}
		\item Implemented in a team of 2 a file system in C that stores images.
		\item Implemented a Server-Client architecture to store and retrieve images.
		\item learned about man pages, Makefiles, software development on Linux, and HTTP.
	\end{itemize}
}
...
\cvitem{Tools}{Git, Jupyter Notebook, Google Colab, yaml, Latex, Linux}
